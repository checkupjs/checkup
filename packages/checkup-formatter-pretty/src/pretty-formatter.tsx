...
const PrettyFormatter: FC<CheckupLogParser> = (logParser: CheckupLogParser) => {
  ...
  let taskResults: Result[] | undefined = logParser.run.results;
...
const TaskResults: FC<{ taskResults: Result[] | undefined }> = ({ taskResults }) => {
  if (taskResults) {
...
// export default class PrettyFormatter implements Formatter {
